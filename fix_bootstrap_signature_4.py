...
# Replace the outer method `pub fn bootstrap`
code = code.replace(
...
# Replace inner method `fn build_gtk_ui`
code = code.replace(
...
# And clear old ShardStatus imports
code = code.replace('use gneiss_pal::shard::ShardStatus;\n', '')
code = code.replace('gneiss_pal::ShardStatus', 'bandy::state::ShardStatus')
import re
