...
|---|---|---|---|
| 31 | PROPOSAL-kepler-fence-pull31 | APPROVED w/ 3 amendments (write-readback safety; explicit post-bind witness leg + pre/post labeling; ENGINE_STATUS raw, CHAN_VALID = hypothesis) — awaiting implementation | FIRST CONTEXT-BIND WRITE: inst_off>>12 → CHAN_CUR/CHAN_NEXT; does PFIFO's strip move for the first time? |
