...
|---|---|---|---|
| 29 | PROPOSAL-kepler-fence-pull29 | APPROVED w/ 4 amendments (post-hb-final placement; W1C observed bits only; NO enable-bit write; PIBUS-first defensive order) — awaiting implementation | CTXCTL subunit-gating theory + PRING fault observe/clear + rotation to 0x409800 — why 0x409504 faults and how to un-wedge |
