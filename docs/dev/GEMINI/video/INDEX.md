...
| Pull | Files | Status | One-liner |
|---|---|---|---|
| 5 | BRIEF-kepler-display-pull5-repoint / PROPOSAL-kepler-display-pull5 | LANDED 896faee0 (+inline _allocator fix) — metal owed s15 | repoint 0x6101E0 to a prepared surface, panel is the verdict; restore |
