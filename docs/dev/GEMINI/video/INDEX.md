...
|---|---|---|---|
| 14 | BRIEF-kepler-fence-pull14-ctrladdr | BRIEFED — awaiting proposal | PBDMA CTRL_ADDR TARGET audit; disp-era USERD fallback |
...
| Pull | Files | Status | One-liner |
|---|---|---|---|
| 3 | BRIEF-kepler-display-pull3-decode | BRIEFED — awaiting proposal | read-only candidate decode (dense windows, 3 passes, arithmetic cross-check) |
