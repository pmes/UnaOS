...
|---|---|---|---|
| 30 | (no proposal — implemented direct from RELAY invitation, flagged) | LANDED 0e26447e; matches invitation exactly (safest-first chain 0x804/0xb00/0xb04/0xc00/0xc08, taint-skip, PRING clear + un-wedge test at first fault, 0x409504 excluded); gated green; awaiting s34; OWED from specialist: PBUS_INTR bits 2+3 decode w/ citation | chain-read five unknown offsets; first FAULT triggers the real un-wedge experiment |
