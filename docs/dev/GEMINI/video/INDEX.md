...
| Pull | Files | Status | One-liner |
|---|---|---|---|
| 4 | BRIEF-kepler-display-pull4-evo-core | BRIEFED — awaiting proposal (serves BOTH lanes; fence holds pending its capture) | EVO core-channel read-out: dense 0x610480 window + known-value scan of 0x610000–0x613FFC |
