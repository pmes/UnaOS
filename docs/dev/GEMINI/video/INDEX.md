...
|---|---|---|---|
| 16 | BRIEF-kepler-fence-pull16-beacon | BRIEFED — awaiting proposal | VRAM beacons in our channel structures; does the volatile 0x640000 window mirror them? |
...
| Pull | Files | Status | One-liner |
|---|---|---|---|
| 9 | BRIEF-kepler-display-pull9-ruler | BRIEFED — awaiting proposal | ruler fill (64-row color cycle + wide left marker) — one photo solves pitch + row mapping |
