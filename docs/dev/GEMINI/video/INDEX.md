...
|---|---|---|---|
| 29 | PROPOSAL-kepler-fence-pull29 | LANDED bbef2747 (+inline: INTR_VALUE read added per approved text); all 4 amendments honored; gated green; awaiting s33 | CTXCTL subunit-gating theory + PRING fault observe/clear + rotation to 0x409800 — why 0x409504 faults and how to un-wedge |
