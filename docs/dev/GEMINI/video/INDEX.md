...
|---|---|---|---|
| 19 | BRIEF-kepler-fence-pull19-pgraph-enable | BRIEFED — awaiting proposal | set PMC_ENABLE bit12 (one write) + re-run recon — BADF1200 should become real values |
...
| Pull | Files | Status | One-liner |
|---|---|---|---|
| 12 | BRIEF-kepler-display-pull12-pitchalign | BRIEFED — awaiting proposal | bh {4,8} × pitch_gobs {192,256} mini-ladder — zero seams names the real pair |
