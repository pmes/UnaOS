...
| Pull | Files | Status | One-liner |
|---|---|---|---|
| 7 | BRIEF-kepler-display-pull7-latch / PROPOSAL-kepler-display-pull7 | LANDED 9ff1a9c2 — metal owed s17 | assembly write (0x640460) + UPDATE latch (0x640080), restore-paired; panel is the verdict |
