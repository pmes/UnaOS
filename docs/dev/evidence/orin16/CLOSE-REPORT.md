...
| #6 (+addendum) | `video/wm.rs`, `dock.rs`, `main.rs`, `wcg.rs` | rmbp 13, 14:1xZ / 14:3xZ; pi 7 (b) 14:2xZ | register the sixth holder or name it unregistered with a reason; ORINWM1 paragraph |
| #7 | `fs/vfs.rs`, `video/shell.rs` | rmbp 13, 14:2xZ | shell.rs same-line cfg symmetry |
| #8 | KEYDOORS-FIX main.rs hunks | rmbp 13 — asked, itemised a–d | fold only F1/F2/F3 main.rs hunks; the `drag_cancel` twin is rmbp's |
