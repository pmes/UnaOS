...
| A29 wcgseam | `A29 wcgseam: ABSENT — the seam never ran this boot; acceptable, NOT a failure (this board has never flown it)` | `video/wcg.rs:410` | ABSENT, as on every Orin boot to date | A29, SO7 |
