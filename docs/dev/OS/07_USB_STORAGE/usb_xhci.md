...
## 38. STORSLOT — the xHCI driver publishes MORE THAN ONE mass-storage device (QUEUE, 2026-09-15)
...
### 40.2 Why this is a PLACE defect and not a CONTENT defect
...
### 40.3 The shape, and why no new mechanism was added
...
### 40.4 The witnesses, and why the `gui` stamp is quoted rather than obeyed
...
### 40.5 What QEMU can and cannot gate
