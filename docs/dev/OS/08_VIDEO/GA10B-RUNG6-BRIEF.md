...
(rung 5a, the vendor ignition, and §5.5's split of the old "rung 5" into 5a and 5b). Ledger A64.
...
DESIGN only (A64 `open`), each blocked on the metal read the rung below it provides — R53's ladder,
