...
Created 2026-09-12 by orin 27 (all lanes, R46). rmbp 19's own measurement, quoted by Peter the same day:
...
## STATE — 2026-09-12
✓ hw-rmbp 73d9d361 == origin, clean, 8 ahead of main (docs: SR13, P14, the landing report) and 1 behind (the 084b79ac merge itself). Lands first.
...
· D1-class: FLIGHT 8+ on the current tree — the x86 track's last metal flight predates its own landing
...
· SR13 strict trigger, R39 battery selector, S6 board names in shared files (50), SR1/SR9/SR10/SR11/SR12 gate classes, SR2 print-screen wedge, A41/B44 keyboard report loss — all trunk-queue rows
