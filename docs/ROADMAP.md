...
| K8b | Retained roots (snapshots): generation-stamped root records in the (already on-disk) snapshot index, K6 typed attrs, drop → reclaim-queue enqueue + drain; user-visible shell verbs (Peter's V3 verdict: day one) |
