...
//! rung 4's brief §3/§4/§10 for the writes and the oracles this reuses; ledger A63 (5a) and A65 (5b).
//!
...
//!
//! THE TWO ONE-DELTA ARMS (ledger A80/A81), each the flown render15-5a rung with EXACTLY ONE value changed,
...
// ── The two ONE-DELTA arms of rung 5a (ledger A80/A81; rung-5 brief §4.1.2 + §8) ───────────────────────
...
/// ledger A65). Only after `ACR-ACCEPTED`; otherwise prints why it did not run.
#[cfg(feature = "ga10bprobe5b")]
