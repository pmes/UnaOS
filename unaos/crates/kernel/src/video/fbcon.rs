...
/// `arch::aarch64::syscall`, the module `arch/aarch64/mod.rs` gates behind `aarch64_el0` (the named
/// EL0 capability; the dock seam itself keeps the implying longhand `any(baremetal, tegra_el0)`
/// spelling, byte-identical to its negated no-op twin — see the EL0-NAMING markers there) — and
/// §5.2's stop-line stands over it
