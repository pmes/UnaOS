...
# The roster, sorted, one per line. These thirteen are INTERACTIVE-ONLY BY DESIGN — `tste` is a
# shell verb and this suite is what it prints. They are listed so that a FOURTEENTH is visible.
