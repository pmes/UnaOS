...
# RUN-BY: bench — ./arroyo mbench --replay <rmbp capture> --spec scripts/specs/x86-witness.spec --platform x86
#   No verb replays it: it asserts a PAYGO+LOGTS+WITNESS-armed rMBP metal boot, not a QEMU capture.
#
