...
#   /boot/VUG.ELF  — the ABSOLUTE path, i.e. probe 2 of `exec_resolve` (the program-source
...
REQUIRE :: BAREXEC: /boot/VUG\.ELF \(typed 'vug'\) — loaded [0-9]+ bytes, entry 0x[0-9a-f]+, pid=[0-9]+ slot=[0-9]+ DETACHED, left RUNNING ::
