...
# RUN-BY: verb:kernel8-test — `arroyo` names this file in code; `test_kernel8` replays it through
#          mbench and its rc is the verb's rc.
#
...
# --- LFNMV (rmbp-ledger B198, 2026-09-23): A RENAME TO A LONG NAME, MEASURED. `el0-stor2mv` asks
