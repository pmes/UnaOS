// libs/quartzite/src/splines/comms.rs
use gtk4::prelude::*;
use gtk4::{
...
impl CommsSpline {
    ...
    pub fn bootstrap<W: IsA<Window> + IsA<Widget> + Cast>(&self, window: &W, tx_event: async_channel::Sender<Event>, rx: Receiver<GuiUpdate>) -> Widget {
        ...
        // Page 1: Rooms (Updated to ColumnView)
        // REPLACING ListBox with ColumnView
        ...
        factory.connect_setup(move |_factory, item| {
            ...
            label.set_margin_top(12); // Spacing
